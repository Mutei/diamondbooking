...
class AuthMethods {
  final FirebaseAuth _auth = FirebaseAuth.instance;
  final DatabaseReference _ref = FirebaseDatabase.instance.ref("App").child("User");
  ...
  Future<void> registerWithEmailAndPassword(
    ...
    try {
      ...
      if (userCredential.user != null) {
        ...
        // Store the user type and registration date in the user's profile
        await _ref.child(userId).set({
          'email': email,
          'TypeUser': typeUser,
          'DateOfRegistration': registrationDate, // Save registration date
        });
